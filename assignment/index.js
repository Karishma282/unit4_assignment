...
const connect =()=>{
    return mongoose.connect("mongodb+srv://dhaval:dhaval_123@cluster0.ljuvz.mongodb.net/fw15-atlas?retryWrites=true&w=majority")
...
app.get("/sections/:id",s=async(req,res)=>{
    try {
